...
/**
 * View in MVC structure. Contain all GUI data. All components as fields,
 * labels, table, etc. was generated in design panel (initComponents method).
 *
...
public class GraphView extends JFrame {
    ...
    /**
     * Creates new form GraphView. Sets headers in tables.
     */
    public GraphView() {
        this.setTitle("Graphs / Floyd Warshall");
        initComponents();
        setData();
    }
    ...
    public String getWeightFieldText() {
        return this.addEdgeWeightField.getText();
    }
