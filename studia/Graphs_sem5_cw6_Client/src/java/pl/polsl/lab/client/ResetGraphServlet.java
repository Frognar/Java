 ...
 */
@WebServlet(name = "ResetGraphServlet", urlPatterns = {"/ResetGraphServlet"})
public class ResetGraphServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String err = resetGraph();
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ResetGraphServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ResetGraphServlet at " + request.getContextPath() + "</h1>");
            out.println(err);
